...
#
# 使用方法:
#   ./run_sac_ablation_Walker2d.sh -n 4
#   ./run_sac_ablation_Walker2d.sh -n 2
#
################################################################################
...
echo "================================================================================"
echo "🚀 SAC 消融实验 (Walker2d) - ${NUM_GPUS} GPUs"
echo "================================================================================"
echo "  环境: GYM-Walker2d-v4 (MuJoCo, 17维状态 → 6维动作)"
...
PBER_CONFIG="configs/experiments/sac/pber/walker2d.yml"
