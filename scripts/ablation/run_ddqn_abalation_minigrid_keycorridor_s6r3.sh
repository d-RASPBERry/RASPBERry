...
################################################################################
# DDQN ablation launcher (MiniGrid-KeyCorridorS6R3)
################################################################################
...
PER_CONFIG="configs/experiments/ddqn/per/minigrid_keycorridor_s6r3.yml"
PBER_CONFIG="configs/experiments/ddqn/pber/minigrid_keycorridor_s6r3.yml"
RASP_CONFIG="configs/experiments/ddqn/raspberry/minigrid_keycorridor_s6r3.yml"
for cfg in "${PER_CONFIG}" "${PBER_CONFIG}" "${RASP_CONFIG}"; do
    [ -f "${cfg}" ] || { echo "Error: missing config ${cfg}" >&2; exit 1; }
done

echo "================================================================================"
echo "DDQN ablation (MiniGrid-KeyCorridorS6R3)"
