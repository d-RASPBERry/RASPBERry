...
################################################################################
# DDQN ablation launcher (Atlantis)
#
...
#
# Usage:
#   ./run_ddqn_abalation_atlantis.sh                # default GPU 0
#   ./run_ddqn_abalation_atlantis.sh -n 0,1,2       # comma-separated GPU list
#   ./run_ddqn_abalation_atlantis.sh -m exclusive   # exclusive mode (3x GPUs)
#
################################################################################
...
PER_CONFIG="configs/experiments/ddqn/per/atlantis.yml"
PBER_CONFIG="configs/experiments/ddqn/pber/atlantis.yml"
RASP_CONFIG="configs/experiments/ddqn/raspberry/atlantis.yml"
