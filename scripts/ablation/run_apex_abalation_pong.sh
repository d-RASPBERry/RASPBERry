...
#
# Usage:
#   ./run_apex_abalation_pong.sh                # default GPU 0
#   ./run_apex_abalation_pong.sh -n 0,1,2       # comma-separated GPU list
#   ./run_apex_abalation_pong.sh -m exclusive   # exclusive mode (3x GPUs)
#
################################################################################
...
PER_CONFIG="configs/experiments/apex/per/pong.yml"
PBER_CONFIG="configs/experiments/apex/pber/pong.yml"
RASP_CONFIG="configs/experiments/apex/raspberry/pong.yml"
