...
################################################################################
# DDQN ablation launcher (MiniGrid-LavaCrossingS9N1)
################################################################################
...
PER_CONFIG="configs/experiments/ddqn/per/minigrid_lavacrossing_s9n1.yml"
PBER_CONFIG="configs/experiments/ddqn/pber/minigrid_lavacrossing_s9n1.yml"
RASP_CONFIG="configs/experiments/ddqn/raspberry/minigrid_lavacrossing_s9n1.yml"
for cfg in "${PER_CONFIG}" "${PBER_CONFIG}" "${RASP_CONFIG}"; do
    [ -f "${cfg}" ] || { echo "Error: missing config ${cfg}" >&2; exit 1; }
done

echo "================================================================================"
echo "DDQN ablation (MiniGrid-LavaCrossingS9N1)"
