...
def build_algorithm(env_id: str, env_short: str, config: dict) -> DQNRaspberryAlgo:
    ...
    Returns:
        Configured DQNRaspberryAlgo instance with PBER buffer
    """
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Path to DDQN-PBER config YAML (default: ddqn_pber_atari.yml)",
    )
