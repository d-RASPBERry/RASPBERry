...
def build_algorithm(env_name: str, env_short: str, config: dict) -> DQN:
...
def main() -> None:
    ...
    run_name = f"DDQN-PER-{args.gpu}-{timestamp}"
    ...
    try:
        while iteration < max_iterations:
            ...
            dump_config = load_buffer_dump_config('dqn', RUNTIME_CONFIG)
